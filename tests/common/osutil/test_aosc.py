...
from azurelinuxagent.common.osutil.aosc import AoscOSUtil
from tests.lib.tools import AgentTestCase
from .test_default import osutil_get_dhcp_pid_should_return_a_list_of_pids


class TestAoscOSUtil(AgentTestCase):
    def setUp(self):
    ...
    def test_get_dhcp_pid_should_return_a_list_of_pids(self):
        osutil_get_dhcp_pid_should_return_a_list_of_pids(self, AoscOSUtil())
